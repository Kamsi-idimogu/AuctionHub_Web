        ...
        <div className={styles.container}>
            ...
            <ol>
                ...
                <li>By accessing this website, you accept these terms 
                    ...
                    Auction Hub if you do not agree to all of the 
                    terms and conditions stated on this page.
                </li>
                <p/>

                <li>License</li>
                <p>Unless otherwise stated, Auction Hub owns the 
                    intellectual property rights for all material. All 
                    intellectual property rights are reserved.
                </p>

                <li>Restrictions</li>
                <p>You are restricted from: <br/>
                    <ul>
                        <li>Selling, and/or commercializing any website material.</li>
                        <li>Using this website in a way that is damaging, or that could 
                ...
                <p>
                In no event shall Auction Hub be liable for anything arising out of or in any
                 way connected with your use of this website.
                </p>

                <li>Variation of Terms</li>
                <p>
                Auction Hub is permitted to revise these terms at any time as it sees fit, and by
