...
const LandingPage = () => {
  ...
  const [featuredAuctions, setFeaturedAuctions] = useState<ViewCatalogResponse[]>([]);
    ...
    <div>
      ...
      <section className={styles.hero_section}>
        <div className={styles.hero_text}>
          ...
          <Button onClick={handleAuctionButtonClick} className={styles.hero_btn}>
            <div>start bidding now</div>
          </Button>
        </div>
      ...
      <section className={styles.featured_section}>
        ...
        <Button onClick={goToAuctionsPage} className={styles.featured_btn}>
          <div>view more</div>
        </Button>
      </section>
      <section className={styles.info_section}>
        ...
        <p>
          {`Before you can bid, you'll need to create an account. 
                    Registration is a straightforward process that requires 
                    you to provide some basic information`}
        </p>
        <Button onClick={goToRegisterPage} className={styles.info_btn}>
          <div>join now</div>
        </Button>
        <h3>Step 2: Explore</h3>
        <p>
          Explore our vast selection of auctions. We offer a diverse range of items, from
          electronics and collectibles to fashion and home goods.
        </p>
        <h3>Step 3: Bid</h3>
        ...
        <div className={styles.info_auctions}>
          ...
          <div className={styles.dutch_auction}>
            ...
            <ul>
              ...
              <li>
                An item is removed if there are no buyers after the lowest price or fixed time is
                reached
              </li>
            </ul>
          </div>
        ...
        <p>
          Actively compete with each other to secure the winnig bid. There are Real-time updates,
          allowing participants to adjust their bids accordingly.
        </p>
        ...
        <Button onClick={handleAuctionButtonClick} className={styles.info_btn}>
          <div>start bidding now</div>
        </Button>
      </section>
    </div>
